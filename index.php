    ...
    <div class="container">
		<div class="col1">
			...
			<div class="blockquote-3">
                ...
                <p>
                    Я - Илона Браима. Это моя третья фамилия и самая любимая. Первая не напрягала,
                    а вторая замучила, я её не хотела, она была длинная, некрасивая и не правильная,
                    зато процесс избавления от неё принёс мне истинное счастье.
                <p>
                    Я часто спрашиваю себя, почему в почти 40 лет, я не какой-нибудь специалист или лидер
                    мнений, почему “они” там, а я здесь.
                </p>
                <p>
                    Я простая женщина, которая идёт по жизни через личные переживания и даже мини
                    страдания, хотя по факту у меня всё хорошо. Я та, кто не страдает вещизмом, не
                    особо привередлива во всём, от этого мечты у меня простые и поэтому часто сбываются.
                </p>
                <p>
                    Из времяпрепровождений - на выходных необходимо с семьей обязательно побывать где-то
                    вне города, посмотреть на достопримечательности или пособирать грибы. Дома должен
                    быть порядок, а домочадцы накормлены. Мне очень важно кому-то помогать, хоть малость
                    и держать связь с друзьями, пусть и немногочисленными.
                </p>
                <p>
                    Раз в год мне жизненно необходимо для кого-то сделать торт из подгузников, раз в
                    полгода - купить себе новое платье и сделать в нём фотосессию. Раз в сезон я делаю
                    ревизию шкафа и игрушек, а раз в месяц перебираю новые накопившиеся фотографии.
                    Раз в неделю я варю суп и каждый день с утра делаю зарядку.
                </p>
                <p>
                    Думаю, что я не сильно отличаюсь от других - страдаю многими зависимостями,
                    например, от мужа и сахара и борюсь с вечно выпирающим животом. Заставляю себя
                    подниматься на девятый этаж по лестнице и читать по-английски.
                </p>
                <p>
                    С удовольствием я только сплю, смотрю на своих детей, когда они дружат и
                    вместе играют или спят или на работающего мужа в умиротворении.
                </p>
                <p>
                    С эти миром кроме людей меня связывает многое - я восхищаюсь природой, но не
                    принимаю смерти, я люблю любить, но хорошо получается ненавидеть. Я хочу дружить,
                    но не всегда дружелюбна.
                </p>
                <p>
                    <b>Зато знаю точно:</b>
                </p>
                <p>
                    - кровать и телевизор отвечают мне взаимностью,
                    <br/>
                    - я рождена жить, чтобы есть, а не наоборот,
                    <br/>
                    - я могу осчастливить любого и также мгновенно опустить его на землю,
                    <br/>
                    - мечты сбываются, все, но не у всех,
                    <br/>
                    - мы можем быть теми, кем можем и не можем, кем не можем.
                </p>
                <p>
